  ...
  return (
    <div>
        ...
        <form onSubmit={saveLoad} className="load-entry-form">
          <div className="field-row">
            <div className="field">
              ...
              >
                <ChevronLeft size={18} strokeWidth={3} style={{ position: "absolute", left: 10 }} />
      ...
      <div style={{ marginTop: showLoadForm ? 60 : 8, marginBottom: 12, display: "flex", alignItems: "center", gap: 0, width: "100%" }}>
        ...
        >
          <span className="loads-pill-circle"><Search size={18} color="#fff" /></span>
          <span className="loads-pill-text">Loads</span>
        </button>
        ...
        {!showLoadForm && (
          <button type="button" className="loads-pill-btn" style={{ flex: 1, minWidth: 0 }} onClick={openNewLoad}>
            ...
            <span className="loads-pill-circle"><Plus size={18} color="#fff" /></span>
          </button>
        )}
      </div>
      {tripLoadsFilter ? (
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
        ...
        <button type="button" className="loads-pill-btn" style={{ flex: 1, minWidth: 0 }} onClick={openNewPendingTrip}>
          ...
          <span className="loads-pill-circle pending-circle"><Plus size={18} color="#fff" /></span>
        </button>
      </div>
