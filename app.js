...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .section-label.loads-label-line-orange::after { background: var(--accent); opacity: 0.55; }
...
function LoadsTab(p) {
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 8, marginBottom: 12, display: "flex", alignItems: "center", gap: 10, width: "100%" }}>
        <div className="section-label loads-label-line-orange" style={{ margin: 0, flex: 2 }}>
          <span>Loads</span>
          <button
            type="button"
          ...
          >
            <Search size={16} color={searchOpen ? "#1A1300" : "var(--text-dim)"} />
          </button>
        </div>
        {!showLoadForm && (
