      ...
      <div className="account-sidebar-panel">
        <div className="account-sidebar-header">
          {view === "menu" ? (
            ...
            <button type="button" className="account-sidebar-back" onClick={() => setView("menu")}><ChevronLeft size={18} /> {{ profile: "My Profile", manage: "Manage Users", companyInfo: "Company Info", settings: "Settings", about: "About TruxFlow", help: "Help & Support" }[view] || "Back"}</button>
          )}
