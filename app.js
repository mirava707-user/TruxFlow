    ...
    <div>
      ...
      <div className="trip-card-v2-list">
        ...
        {rows.map(({ trip: t, miles, gross, fin }) => (
          ...
          >
            {t.driver2 && (
              <div className="trip-note-badge trip-note-badge-left" title={t.driver2}>
                <MessageSquare
                  size={14}
                  color={t.driver2Color === "green" ? "#4CAF6D" : t.driver2Color === "red" ? "#E15C4F" : "var(--text-dim)"}
                  fill={t.driver2Color === "green" ? "#4CAF6D" : t.driver2Color === "red" ? "#E15C4F" : "none"}
                  style={!t.driver2Color || t.driver2Color === "clear" ? { opacity: 0.35 } : undefined}
                />
              </div>
            )}
            {t.tripNote && (
