...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .loads-status-seg { flex: 1; display: flex; align-items: center; justify-content: center; gap: 6px; padding: 0 10px; height: 32px; background: transparent; border: none; border-radius: 999px; color: var(--text); font-family: 'Oswald', sans-serif; font-weight: 700; font-size: 13px; cursor: pointer; position: relative; }
  .loads-status-seg.active { background: var(--accent); color: #fff; }
  .loads-status-divider { width: 1px; height: 18px; background: var(--border); align-self: center; flex-shrink: 0; }
  .loads-status-dot { width: 8px; height: 8px; border-radius: 50%; background: #fff; flex-shrink: 0; }
  ...
  .loads-new-load-btn { display: flex; align-items: center; gap: 8px; background: var(--accent); border: 1.5px solid #fff; border-radius: 19px; padding: 0 13px; height: 38px; color: #1A1300; font-family: 'Oswald', sans-serif; font-weight: 700; font-size: 12.5px; text-transform: uppercase; letter-spacing: 1px; cursor: pointer; white-space: nowrap; }
        ...
        <>
          ...
          <div className="loads-status-row">
            <button type="button" className={`loads-status-seg ${filterStatus === "active" ? "active" : ""}`} onClick={() => setFilterStatus("active")}>
              <span className="loads-status-dot" style={filterStatus === "active" ? undefined : { background: "var(--red)" }} /> Active
            </button>
            ...
            <button type="button" className={`loads-status-seg ${filterStatus === "completed" ? "active" : ""}`} onClick={() => setFilterStatus("completed")}>
              <CheckCircle2 size={14} color={filterStatus === "completed" ? "#fff" : "var(--green)"} /> Completed
            </button>
            ...
            <button type="button" className={`loads-status-seg ${filterStatus === "all" ? "active" : ""}`} onClick={() => setFilterStatus("all")}>
              <List size={14} color={filterStatus === "all" ? "#fff" : "var(--text)"} /> All
            </button>
          </div>
