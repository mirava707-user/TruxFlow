...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .load-card-v2-route { font-family: 'Oswald', sans-serif; font-size: 12px; font-weight: 600; color: var(--text-dim); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; min-width: 0; }
  .load-card-v2-right-top { display: flex; align-items: center; gap: 10px; flex-shrink: 0; }
  .load-card-v2-meta { display: flex; align-items: center; gap: 3px; font-family: 'IBM Plex Mono', monospace; font-size: 14px; font-weight: 600; color: var(--text-dim); white-space: nowrap; }
  ...
  .load-card-v2-wo { font-family: 'Oswald', sans-serif; font-weight: 700; font-size: 16px; color: var(--text); letter-spacing: 0.6px; }
  ...
  .trip-stats-bar { display: flex; align-items: center; gap: 10px; background: var(--surface); border: 1px solid var(--border); border-radius: 12px; padding: 12px 14px; margin-bottom: 16px; }
            ...
            <div className="card-head" onClick={() => setExpandedLoadId(open ? null : l.id)}>
              <div className="load-card-v2-row1">
                <div className="load-card-v2-left">
                  ...
                  <span className="load-card-v2-route">{routeSummary(l)}</span>
                </div>
                <div className="load-card-v2-right-top">
                  <span className="load-card-v2-meta"><Truck size={12} color="var(--text-dim)" /> {l.truck || "—"}</span>
                  <span className="load-card-v2-meta"><Calendar size={12} color="var(--text-dim)" /> {shortDate(l.pickupDate)}</span>
              ...
              <div className="load-card-v2-row2">
                <span className="load-card-v2-wo">{l.workOrder || "—"}</span>
    ...
    <div>
      ...
      <div className="trip-stats-bar">
        <div className="trip-stat-item">
          ...
          <div className="trip-stat-lbl">Total</div>
        </div>
    ...
    <div>
      ...
      <div className="trip-card-list">
        {filtered.map((l) => {
          ...
          return (
          <div className="card" key={l.id} style={l.notes ? { borderRight: "3px solid #E15C4F" } : undefined}>
            <div className="card-head" onClick={() => setExpandedId(open ? null : l.id)} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }}>
                ...
                <div onClick={(e) => e.stopPropagation()}>
                  {category === "completed" && (
                    <button className="btn" style={{ marginTop: 0, width: "auto", padding: "6px 12px", fontSize: 11 }} onClick={() => handleInvoice(l)}>Invoice</button>
                  )}
                  {category === "invoiced" && (
                    <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                      ...
                      <button className="btn" style={{ marginTop: 0, width: "auto", padding: "6px 12px", fontSize: 11 }} onClick={() => markLoadPaid(l.id)}>Mark as Paid</button>
                    </div>
                  )}
                  {category === "paid" && (
