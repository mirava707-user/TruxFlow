...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .stub-header2 { border-bottom: 2px solid #1A1F27; padding-bottom: 14px; margin-bottom: 16px; }
  .stub-logo-center-wrap { display: flex; justify-content: center; margin-bottom: -6px; }
  .stub-logo-center { height: 88px; max-width: 260px; object-fit: contain; }
  .stub-info-row { display: flex; justify-content: space-between; align-items: flex-start; gap: 14px; margin-bottom: 4px; }
  .stub-driver-block { text-align: right; flex-shrink: 0; }
  .stub-driver-name { font-family: 'Oswald', sans-serif; font-size: 15px; font-weight: 600; color: #1A1F27; }
  .stub-driver-truck { font-size: 11px; color: #666; font-family: 'IBM Plex Mono', monospace; margin-top: 2px; font-weight: 700; }
  ...
  .stub-gen-date { font-family: 'IBM Plex Mono', monospace; font-weight: 700; font-size: 12.5px; color: #1A1F27; }
  .stub-subline-row { display: flex; justify-content: space-between; align-items: baseline; margin-top: 4px; }
  .stub-miles-line { font-size: 11px; color: #666; font-family: 'IBM Plex Mono', monospace; }
  .stub-period-line { font-size: 11px; color: #666; font-family: 'IBM Plex Mono', monospace; text-align: right; }
  ...
  .pdf-mode .stub-logo-center { height: 104px; max-width: 300px; }
  ...
  if (viewingStubRecord) {
    ...
    return (
      <div>
        ...
        <div className="print-area stub-sheet">
          <div className="stub-header2">
            {companyInfo && companyInfo.companyLogoDataUri && (
              <div className="stub-logo-center-wrap"><img src={companyInfo.companyLogoDataUri} alt="Company logo" className="stub-logo-center" /></div>
            )}
            <div className="stub-info-row">
              <div className="stub-brand-text">
                {companyInfo && companyInfo.companyName ? <div className="stub-company2">{companyInfo.companyName}</div> : null}
                {companyInfo && companyInfo.companyAddress ? <div className="stub-company2-line">{companyInfo.companyAddress}</div> : null}
              ...
              <div className="stub-driver-block">
            ...
            <div className="stub-title-row">
              ...
              <div className="stub-gen-date">{r.generatedAt ? mmddyyyySlash(r.generatedAt.slice(0, 10)) : ""}</div>
            </div>
            ...
            <>
              <div className="print-area stub-sheet" style={{ marginTop: 16 }}>
                <div className="stub-header2">
                  ...
                  <div className="stub-title-row">
                    <div className="stub-title2">Payment Statement</div>
                    <div className="stub-gen-date">{mmddyyyySlash(todayISO())}</div>
                  </div>
                  <div className="stub-subline-row">
