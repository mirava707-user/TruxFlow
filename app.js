              ...
              <>
                ...
                <div className="stub-total-gross-box" style={{ flexWrap: "wrap", gap: 8 }}>
                  ...
                  <span style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    {money(dashReport.totalAmount)}
                    <button
                      type="button"
                      onClick={toggleOrFiled}
                      style={orFiled
                        ? { display: "flex", alignItems: "center", gap: 5, background: "var(--green)", border: "none", borderRadius: 8, padding: "6px 11px", color: "#0E2318", fontFamily: "'Oswald', sans-serif", fontWeight: 700, fontSize: 11.5, cursor: "pointer" }
                        : { display: "flex", alignItems: "center", gap: 5, background: "transparent", border: "1px solid var(--border)", borderRadius: 8, padding: "6px 11px", color: "var(--text-dim)", fontFamily: "'Oswald', sans-serif", fontWeight: 700, fontSize: 11.5, cursor: "pointer" }}
                    >
