      ...
      <div className="trip-card-v2-list">
        ...
        {rows.map(({ trip: t, miles, gross, fin }) => (
          <div
            ...
            onClick={() => openTrip(t)}
            style={{
              ...(t.tripNote && t.tripNoteColor && t.tripNoteColor !== "clear" ? { borderRight: `3px solid ${t.tripNoteColor === "green" ? "#4CAF6D" : "#E15C4F"}` } : {}),
              ...(t.driver2 && t.driver2Color && t.driver2Color !== "clear" ? { borderLeft: `3px solid ${t.driver2Color === "green" ? "#4CAF6D" : "#E15C4F"}` } : {}),
            }}
          >
