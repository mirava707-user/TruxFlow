...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .loads-status-seg { flex: 1; display: flex; align-items: center; justify-content: center; gap: 5px; padding: 0 6px; height: 38px; background: var(--surface); border: none; border-right: 1px solid var(--border); color: var(--text); font-family: 'Oswald', sans-serif; font-weight: 700; font-size: 13px; cursor: pointer; }
  ...
  .loads-truck-dropdown-btn { display: flex; align-items: center; gap: 6px; background: var(--surface); border: 1px solid var(--border); border-radius: 10px; padding: 6px 11px; color: var(--text); font-family: 'Oswald', sans-serif; font-weight: 600; font-size: 11.5px; cursor: pointer; }
  .loads-truck-popover span { color: var(--text); font-family: 'Oswald', sans-serif; font-size: 12.5px; font-weight: 600; }
  .loads-close-all-btn { display: flex; align-items: center; gap: 6px; background: var(--surface); border: 1px solid var(--red); border-radius: 10px; padding: 6px 11px; color: var(--red); font-family: 'Oswald', sans-serif; font-weight: 600; font-size: 11.5px; cursor: pointer; }
  .loads-new-load-btn { display: flex; align-items: center; gap: 8px; background: transparent; border: 1px solid var(--accent); border-radius: 10px; padding: 0 13px; height: 38px; color: var(--accent); font-family: 'Oswald', sans-serif; font-size: 12.5px; text-transform: uppercase; letter-spacing: 1px; cursor: pointer; white-space: nowrap; }
  ...
  return (
    <div>
      ...
      <div className="section-label no-line" style={{ marginTop: 8, gap: 10, width: "100%" }}>
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, background: "transparent", border: "1px solid var(--accent)", borderRadius: 10, padding: "0 13px", height: 38 }}>
          <span>Loads</span>
          <button
            type="button"
