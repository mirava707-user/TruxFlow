            ...
            <div className="stub-header2-top">
              <div className="stub-brand">
                ...
                <div className="stub-brand-text">
                  ...
                  {r.trucksUsed && r.trucksUsed.length ? <div className="stub-company2-line">Truck{r.trucksUsed.length > 1 ? "s" : ""} {r.trucksUsed.join(", ")}</div> : null}
                </div>
              </div>
              <div className="stub-meta2">
                <div className="stub-meta2-num">{r.generatedAt ? mmddyyyySlash(r.generatedAt.slice(0, 10)) : ""}</div>
                <div className="stub-meta2-line">Pay Period: {payPeriodLabel(r.periodStart, r.periodEnd)}</div>
              </div>
            </div>
            <div className="stub-title-row">
                  ...
                  <div className="stub-header2-top">
                    <div className="stub-brand">
                      ...
                      <div className="stub-brand-text">
                        ...
                        {stub.trucksUsed.length ? <div className="stub-company2-line">Truck{stub.trucksUsed.length > 1 ? "s" : ""} {stub.trucksUsed.join(", ")}</div> : null}
                      </div>
                    </div>
                    <div className="stub-meta2">
                      <div className="stub-meta2-num">{mmddyyyySlash(todayISO())}</div>
                      <div className="stub-meta2-line">Pay Period: {payPeriodLabel(stubStart, stubEnd)}</div>
                    </div>
                  </div>
                  <div className="stub-title-row">
                    <div className="stub-title2">Payment Statement</div>
