...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .stub-logo-center { height: 110px; max-width: 300px; object-fit: contain; }
  ...
  .stub-period-line { font-size: 11px; color: #666; margin-top: 4px; font-family: 'IBM Plex Mono', monospace; text-align: right; }
  ...
  .pdf-mode .stub-logo-center { height: 130px; max-width: 340px; }
