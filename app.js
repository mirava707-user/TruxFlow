...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .stub-logo-center-wrap { display: flex; justify-content: center; margin-bottom: 14px; }
  .stub-logo-center { height: 74px; max-width: 220px; object-fit: contain; }
  ...
  .stub-driver-name { font-family: 'Oswald', sans-serif; font-size: 15px; font-weight: 700; color: #1A1F27; }
  .stub-driver-truck { font-size: 11px; color: #666; font-family: 'IBM Plex Mono', monospace; margin-top: 2px; }
  ...
  .stub-period-line { font-size: 11px; color: #666; margin-top: 6px; font-family: 'IBM Plex Mono', monospace; }
  ...
  .pdf-mode .stub-logo-center { height: 92px; max-width: 260px; }
