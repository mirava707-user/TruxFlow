  ...
  return (
    <div style={{ position: "relative" }}>
      <button
        ...
        style={{ position: "fixed", top: "calc(8px + env(safe-area-inset-top))", right: 8, zIndex: 9999, background: "#1D2430", color: "#8A93A3", border: "1px solid #303A4A", borderRadius: 8, padding: "6px 10px", fontSize: 10, fontFamily: "Inter, sans-serif", cursor: "pointer" }}
      >
        Sign Out
      </button>
      <DispatchApp key={session.user.id} />
    </div>
  );
}
