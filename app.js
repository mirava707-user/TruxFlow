          ...
          <div className="card loads-list-card" key={l.id} style={cardStyle}>
            <div className="card-head" onClick={() => setExpandedLoadId(open ? null : l.id)}>
              ...
              <div className="load-card-v2-row2">
                <span className="load-card-v2-wo" style={l.bolDataUri ? { color: "var(--accent)" } : undefined}><Pencil size={12} color={l.bolDataUri ? "var(--accent)" : "var(--green)"} style={{ display: "inline", verticalAlign: -1 }} /> {l.workOrder || "—"}</span>
