...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .dash-filter-card { display: flex; align-items: center; gap: 10px; background: var(--surface); border: 1px solid var(--border); border-radius: 14px; padding: 12px 14px; position: relative; }
  ...
  .dash-filter-select-v2 {
    appearance: none; -webkit-appearance: none; -moz-appearance: none;
    background: transparent; border: none; color: var(--text); font-family: 'Oswald', sans-serif; font-weight: 700; font-size: 13.5px; padding: 0; width: 100%; cursor: pointer;
  }
  .dash-filter-select-v2:focus { outline: none; }
  .dash-filter-select-v2 option { font-family: 'Oswald', sans-serif; background: var(--surface); color: var(--text); }
  .dash-filter-btn-v2 { display: block; width: 100%; background: transparent; border: none; padding: 0; cursor: pointer; text-align: left; font-family: 'Oswald', sans-serif; font-weight: 700; font-size: 13.5px; color: var(--text); }
    ...
    <div>
      <div className="dash-filter-grid" style={{ gridTemplateColumns: "1fr" }}>
        <div className="dash-filter-card">
          <div className="dash-filter-icon-wrap"><BarChart3 size={16} /></div>
          <div className="dash-filter-body">
            <div className="dash-filter-label">Report</div>
            <select className="dash-filter-select-v2" value={dashViewBy} onChange={(e) => setDashViewBy(e.target.value)}>
      ...
      {isAnnualTax && (
        <div className="dash-filter-grid" style={{ gridTemplateColumns: "1fr" }}>
          <div className="dash-filter-card">
            ...
            <div className="dash-filter-body">
              <div className="dash-filter-label">Tax Year</div>
              <select className="dash-filter-select-v2" value={annualTaxYear} onChange={(e) => setAnnualTaxYear(Number(e.target.value))}>
      ...
      {!isAnnualTax && (dashViewBy === "dispatcher" ? (
        <>
          <div className="dash-filter-grid">
            <div className="dash-filter-card">
              ...
              <div className="dash-filter-body">
                <div className="dash-filter-label">Dispatcher</div>
                <select className="dash-filter-select-v2" value={dashDispatcherFilter} onChange={(e) => setDashDispatcherFilter(e.target.value)}>
            ...
            <div className="dash-filter-card">
              <div className="dash-filter-icon-wrap"><Truck size={16} /></div>
              <div className="dash-filter-body">
                <div className="dash-filter-label">Truck</div>
                <select className="dash-filter-select-v2" value={dashTruckFilter} onChange={(e) => setDashTruckFilter(e.target.value)}>
          ...
          <div className="dash-filter-grid" style={{ gridTemplateColumns: "1fr" }}>
            <div className="dash-filter-card">
              <div className="dash-filter-icon-wrap"><Calendar size={16} /></div>
              <div className="dash-filter-body">
                <div className="dash-filter-label">Period</div>
                <select className="dash-filter-select-v2" value={dashPeriod} onChange={(e) => onDashPeriodChange(e.target.value)}>
        ...
        <>
          <div className="dash-filter-grid">
            <div className="dash-filter-card" style={{ position: "relative" }}>
              ...
              <div className="dash-filter-body">
                ...
                <button type="button" className="dash-filter-btn-v2" onClick={() => setDriverDropdownOpen((v) => !v)}>
          ...
          <div className="dash-filter-grid">
            <div className="dash-filter-card">
              <div className="dash-filter-icon-wrap"><Building2 size={16} /></div>
              <div className="dash-filter-body">
                <div className="dash-filter-label">Bill To / Broker</div>
                <select className="dash-filter-select-v2" value={dashBillToFilter} onChange={(e) => setDashBillToFilter(e.target.value)}>
                  <option value="ALL">All</option>
    ...
    <div>
      ...
      <form onSubmit={saveTruck}>
        ...
        <div className="field-row">
          ...
          <div className="field">
            <label>Status</label>
            <select value={truckForm.active === false ? "inactive" : "active"} onChange={(e) => setTruckForm({ ...truckForm, active: e.target.value === "active" })} style={{ fontFamily: "Inter" }}>
              <option value="active">Active</option>
      ...
      <form onSubmit={saveDriver}>
        ...
        <div className="field-row">
          <div className="field">
            ...
            <select value={driverForm.payType} onChange={(e) => setDriverForm({ ...driverForm, payType: e.target.value })} style={{ fontFamily: "Inter" }}>
        ...
        <div className="field-row">
          ...
          <div className="field">
            <label>Status</label>
            <select value={driverForm.active === false ? "inactive" : "active"} onChange={(e) => setDriverForm({ ...driverForm, active: e.target.value === "active" })} style={{ fontFamily: "Inter" }}>
              <option value="active">Active</option>
              <option value="inactive">Inactive</option>
            </select>
          </div>
    ...
    <div>
      ...
      <form onSubmit={saveBillTo}>
        ...
        <div className="field-row">
          ...
          <div className="field">
            <label>Status</label>
            <select value={billToForm.active === false ? "inactive" : "active"} onChange={(e) => setBillToForm({ ...billToForm, active: e.target.value === "active" })} style={{ fontFamily: "Inter" }}>
              <option value="active">Active</option>
              <option value="inactive">Inactive</option>
            </select>
          </div>
      ...
      <form onSubmit={saveDispatcher}>
        ...
        <div className="field-row">
          <div className="field">
            ...
            <select value={dispatcherForm.payMethod} onChange={(e) => setDispatcherForm({ ...dispatcherForm, payMethod: e.target.value })} style={{ fontFamily: "Inter" }}>
        ...
        <div className="field-row">
          <div className="field">
            ...
            <select value={dispatcherForm.position} onChange={(e) => setDispatcherForm({ ...dispatcherForm, position: e.target.value })} style={{ fontFamily: "Inter" }}>
              <option value="dispatcher">Dispatcher</option>
          ...
          <div className="field">
            <label>Status</label>
            <select value={dispatcherForm.active ? "active" : "inactive"} onChange={(e) => setDispatcherForm({ ...dispatcherForm, active: e.target.value === "active" })} style={{ fontFamily: "Inter" }}>
              <option value="active">Active</option>
              <option value="inactive">Inactive</option>
            </select>
          </div>
      ...
      {mode === "build" && (
        <>
          <div className="field-row">
            <div className="field">
              <label>Truck</label>
              <select value={report.truck} onChange={(e) => setReport({ ...report, truck: e.target.value })} style={{ fontFamily: "Inter" }}>
          ...
          <div className="field-row">
            <div className="field">
              <label>Quarter</label>
              <select value={report.quarter} onChange={(e) => setReport({ ...report, quarter: Number(e.target.value) })} style={{ fontFamily: "Inter" }}>
