...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .load-card-v2-wo { font-family: 'IBM Plex Mono', monospace; font-weight: 700; font-size: 16px; color: #2456A0; letter-spacing: 0.6px; }
  .load-card-v2-right-bottom { display: flex; align-items: center; gap: 8px; flex-shrink: 0; }
  .load-card-v2-rate { font-family: 'IBM Plex Mono', monospace; font-weight: 800; font-size: 15px; color: var(--text); }
          ...
          <div className="card" key={l.id} style={l.notes ? { borderRight: "3px solid #E15C4F" } : undefined}>
            <div className="card-head" onClick={() => setExpandedLoadId(open ? null : l.id)}>
              ...
              <div className="load-card-v2-row2">
                <span className="load-card-v2-wo"><Pencil size={12} color="#2456A0" style={{ display: "inline", verticalAlign: -1 }} /> {l.workOrder || "—"}</span>
