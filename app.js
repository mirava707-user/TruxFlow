...
function LoginScreen() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(rgba(20,24,31,0.55), rgba(20,24,31,0.8)), url('login-bg.jpg') center/cover no-repeat", padding: 20, fontFamily: "Inter, sans-serif" }}>
