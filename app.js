      ...
      <div className="account-sidebar-panel">
        ...
        {view === "profile" && (
          <div className="account-modal-body">
            ...
            <button type="button" className="btn danger" style={{ marginTop: 10, width: "100%" }} onClick={() => { onClose(); onSignOut(); }}>Sign Out</button>
          </div>
        )}
...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .account-sidebar-header { display: flex; align-items: center; justify-content: space-between; padding: 16px; border-bottom: 1px solid var(--border); flex-shrink: 0; }
  ...
  .account-sidebar-menu { display: flex; flex-direction: column; }
