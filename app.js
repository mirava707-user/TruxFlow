...
function printWithFilename(filename) {
  ...
  setTimeout(restoreTitle, 8000); // fallback safety net in case focus never fires
}
...
const emptyTrip = () => ({
  ...
  paidStatus: "unpaid", paidStubId: null, tripStatus: "active",
});
function normalizeTrip(t) {
  const base = { paidStatus: "unpaid", paidStubId: null, driver2Color: "clear", otherChargesList: [], logbookMonth: "", insuranceMonth: "", orPermitNote: "", truckPayNote: "", tripStatus: "active", ...t };
...
function DispatchApp({ onSignOut, userEmail } = {}) {
  ...
  async function saveAndPrintDispatcherStub(dispatcherName, start, end, stubData) {
    ...
    printWithFilename(dispatcherPayFilename(record));
  }
  ...
  async function saveAndPrintStub() {
    ...
    printWithFilename(driverPayFilename(record, trips));
  }
        ...
        <div className={`content ${textScale === "large" ? "text-large" : ""}`}>
          ...
          {tab === "expenses" && expensesView === "detail" && (
            <ExpenseDetail {...{
              ...
              driverByName, askConfirm, nextTripNumber,
            }} />
          )}
      ...
      {printingLoad && (
        <div className="modal-overlay" onClick={() => setPrintingLoad(null)}>
          <div className="modal-sheet" onClick={(e) => e.stopPropagation()}>
            ...
            <button className="btn no-print" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }} onClick={() => printWithFilename(loadConfirmationFilename(printingLoad))}><Printer size={16} /> Print / Save as PDF</button>
      ...
      <div className="trip-table">
        ...
        {rows.map(({ trip: t, miles, gross, fin }) => (
          <div className="trip-table-row" key={t.id} onClick={() => openTrip(t)}>
            <span className="tt-col-trip trip-table-num" style={t.tripStatus === "pending" ? { color: "#E15C4F" } : undefined}>{t.tripStatus === "pending" ? "P" : t.tripNumber}</span>
...
function ExpenseDetail(p) {
  const { tripForm, setTripForm, activeTripId, truckNumbers, driverNames, computeTripMilesGross, computeTripProfit, saveTrip, deleteTrip, closeTripDetail, driverByName, askConfirm, nextTripNumber } = p;
  ...
  if (viewingRecord) {
    ...
    return (
      <div>
        ...
        <button className="btn no-print" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }} onClick={() => printWithFilename(dispatcherPayFilename(r))}><Printer size={16} /> Print / Save as PDF</button>
  ...
  if (viewingStubRecord) {
    ...
    return (
      <div>
        ...
        <button className="btn no-print" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }} onClick={() => printWithFilename(driverPayFilename(r, trips))}><Printer size={16} /> Print / Save as PDF</button>
  ...
  if (printingInvoice) {
    ...
    return (
      <div>
        ...
        <button className="btn no-print" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }} onClick={() => printWithFilename(invoiceFilename(printingInvoice))}><Printer size={16} /> Print / Save as PDF</button>
      </div>
    );
  }
  ...
  if (viewingReport) {
    ...
    return (
      <div>
        ...
        <button className="btn no-print" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }} onClick={() => printWithFilename(iftaFilename(viewingReport))}><Printer size={16} /> Print / Save as PDF</button>
