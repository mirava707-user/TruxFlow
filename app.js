...
function TimezoneSection({ settings, saveSettings }) {
...
function AccountSidebar({ userEmail, onSignOut, onClose, settings, saveSettings, saveStartingNumber, nextLoadNumber, askConfirm, unreadSupportCount }) {
  const hasBackend = typeof sb !== "undefined";
  ...
  return (
    <>
      ...
      <div className="account-sidebar-panel">
        ...
        {view === "timezone" && <TimezoneSection settings={settings} saveSettings={saveSettings} />}
    ...
    <div>
      ...
      <form onSubmit={saveTrip}>
        ...
        <div className="field-row date-row">
          <div className="field"><label>Start Date</label><input type="date" min={minStartDate} onClick={(e) => { try { e.target.showPicker(); } catch (_) {} }} value={tripForm.startDate} onChange={(e) => setTripForm({ ...tripForm, startDate: e.target.value })} /></div>
