...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .stub-gen-date { font-family: 'IBM Plex Mono', monospace; font-weight: 700; font-size: 11px; color: #666; margin-top: 5px; }
  .stub-subline-row { display: flex; justify-content: space-between; align-items: baseline; margin-top: 8px; }
