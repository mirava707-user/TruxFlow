    ...
    <div className={`theme-${settings.theme || "dark"}`} style={{ background: "var(--bg)", minHeight: "100vh", fontFamily: "Inter, sans-serif" }}>
      ...
      <div className="app-shell">
        ...
        <div
          ...
          style={{ transform: (pullDistance || refreshing) ? `translateY(${refreshing ? PULL_THRESHOLD : pullDistance}px)` : undefined, transition: isPulling.current ? "none" : "transform 0.25s ease" }}
        >
          {tab === "loads" && (
            <LoadsTab {...{
