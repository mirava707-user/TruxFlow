...
function DispatchApp({ onSignOut, userEmail } = {}) {
  ...
  const dashReport = useMemo(() => {
    ...
    if (f.viewBy === "dispatcher") {
      ...
      const avgRevPerLoad = loadCount > 0 ? grossTotal / loadCount : 0;
      return {
        viewBy: f.viewBy, selectedName, dispatcher, grossTotal, loadCount, avgRevPerLoad, pay,
...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .truck-standout { color: var(--accent); background: #F2A93B22; padding: 2px 7px; border-radius: 6px; }
          ...
          <div className="card" key={l.id}>
            <div className="card-head" onClick={() => setExpandedLoadId(open ? null : l.id)}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4 }}>
                {l.workOrder && <span className="truck-pill">{l.workOrder}</span>}
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      ...
      {isDispatcher ? (
        !dashReport.selectedName ? (
          ...
          <>
            <div className="report-grid" style={{ gridTemplateColumns: "1fr 1fr" }}>
              ...
              <div className="stat-box"><div className="num">{compactMoney(dashReport.avgRevPerLoad)}</div><div className="lbl">Avg Revenue / Load</div></div>
            </div>
        ...
        <>
          ...
          <div className="expense-report-list">
            ...
            <div className="expense-report-row" style={{ borderColor: "var(--accent)", background: "var(--surface-2)", marginTop: 6 }}>
