...
const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .load-card-v2-meta { display: flex; align-items: center; gap: 3px; font-family: 'IBM Plex Mono', monospace; font-size: 11.5px; font-weight: 600; color: var(--text-dim); white-space: nowrap; }
  ...
  .load-card-v2-wo { font-family: 'Oswald', sans-serif; font-weight: 700; font-size: 16px; color: var(--text); }
  ...
  .trip-stats-bar { display: flex; align-items: center; justify-content: space-evenly; gap: 4px; background: var(--surface); border: 1px solid var(--border); border-radius: 12px; padding: 12px 10px; margin-bottom: 16px; }
        ...
        {filtered.map((l) => {
          ...
          <div className="card" key={l.id} style={l.notes ? { borderRight: "3px solid #E15C4F" } : undefined}>
            <div className="card-head" onClick={() => setExpandedId(open ? null : l.id)}>
              ...
              <div className="load-card-v2-row2">
                <span className="load-card-v2-wo">{l.workOrder || "—"}</span>
                <div className="load-card-v2-right-bottom" onClick={(e) => e.stopPropagation()}>
                  {category === "completed" && (
